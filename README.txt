...
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o algo.o -c algo.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o base.o -c base.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o benchmark.o -c benchmark.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o main.o -c main.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o matrix.o -c matrix.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o tests.o -c tests.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o unit_test.o -c unit_test.c
gcc -g -Wall -O2 -pg -lm -lgmp -lmpfr -o main algo.o base.o benchmark.o main.o matrix.o tests.o unit_test.o -lm -lmpfr -lgmp
